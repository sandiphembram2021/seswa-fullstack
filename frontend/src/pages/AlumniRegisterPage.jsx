...
const AlumniRegisterPage = () => {
  ...
  const validateStep2 = () => {
    if (!formData.collegeId || !formData.branch || !formData.graduationYear || !formData.district) {
    ...
    try {
      ...
      if (result.success) {
        navigate('/alumni/login', { 
          state: { 
            message: 'Alumni registration successful! Please check your email for verification.' 
          }
        });
      } else {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Join SESWA as an engineering graduate
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-lg sm:px-10 border-t-4 border-green-500">
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-between mt-2">
              ...
              <span className="text-xs text-gray-600">Professional Info</span>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button
                    ...
                    className="flex-1 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <Link
                to="/alumni/login"
                className="w-full flex justify-center py-2 px-4 border border-green-600 rounded-lg text-sm font-medium text-green-600 bg-white hover:bg-green-50 transition-colors duration-200"
              >
                Sign in as alumni
              </Link>
            </div>
