...
const AlumniLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await login(formData.email, formData.password, 'alumni');
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Sign in to your SESWA alumni account
        </p>
      </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New alumni?</span>
              </div>
            </div>
